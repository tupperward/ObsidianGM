...
---
## Attacks
| Melee `INPUT[toggle:trained_melee]` | Ranged `INPUT[toggle:trained_ranged]` | Brawl | Finesse |
|:---:|:---:|:---:|:---:|
| `VIEW[20 - {might} * (1 + number({trained_melee}))][math]` | `VIEW[20 - {awareness} * (1 + number({trained_ranged}))][math]` | `VIEW[20 - {might} * (1 + number({trained_brawl}))][math]` | `VIEW[20 - {dexterity} * (1 + number({trained_finesse}))][math]` |
---
## Weapons
