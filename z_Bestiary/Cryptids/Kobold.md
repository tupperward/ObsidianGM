...
***ABILITIES***
---
**Pack Instincts:** If one of its Allies is within 5' of a Target of this Being's Attack, that Target is Vulnerable against the Attack. Type Changes
**Sling [Ranged Attack]:** 2 (d4)
**Dagger [Melee Attack, Thrown]:** 2 (d4) Alchemist Alchemist's Fire [Melee Attack, Thrown] (5/Day): 3 (d6) and Burning (Cd6)
**Dagger [Melee Attack, Thrown]:** 2 (d4)
**Warrior Armor:** 2 [as Leather plus Shield]
