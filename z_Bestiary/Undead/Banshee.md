...
actions:
  - name: "Wail [Action while in darkness, all Near who hear it | Will (1/Day)]"
    desc: Frightened (Cd4) or immediate death if failed by 5 or more
  - name: "Chill Touch [Melee Attack]"
    desc: 4 (1d8)
abilities:
  - name: Nightwalker
    desc: "Can't Move or Target over lines of salt or in areas illuminated by Sunlight. It is Incapacitated and Burning (1d8) while in Sunlight. Terror II — Enemies' first time seeing it and on their Turns | Will: Frightened until they pass this Check on a subsequent Turn, or for Cd6 after."
columns: 2
forceColumns: true
bestiary: true
---
