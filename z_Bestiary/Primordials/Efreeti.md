...
immune: Fire
actions:
  - name: "Wall of Fire [Cast, 60ft Line | Reflex (3/Day, Focus)]"
    desc: "Burning (1d6, while in the flames). It takes this damage the first time it enters the flames while it isn't Burning as well."
  - name: "Conjure Object [Cast, Remote | Reflex (3/Day)]"
    desc: "An Object no larger than 10ft×10ft is created. Objects made this way composed of metal or stone disappear after one day."
  - name: Combo
    desc: 2×Fist
  - name: "Fist [Melee Attack]"
    desc: 9 (2d8)
