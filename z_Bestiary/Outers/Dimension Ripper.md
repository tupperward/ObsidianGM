...
actions:
  - name: "Temporal Lock [Cast, Sight | Will (Recharge Cd4)]"
    desc: Paralyzed (Cd4)
  - name: Combo
    desc: "2×Claw and 1×Bite (+1) Bite — Melee Attack: 5 (1d8+1) (+1) Claw — Melee Attack: 8 (2d6+1)"
abilities:
  - name: Maddening I
    desc: "Enemies that can hear it for the first time and at the start of their Turns must pass — Will or be Confused (Cd4)."
  - name: Terror I
